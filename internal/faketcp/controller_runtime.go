...
func (runtime *ControllerRuntime) PauseForStartupGuard(
	ctx context.Context,
...
func (runtime *ControllerRuntime) ResumeAfterStartupGuard(
	ctx context.Context,
	...
	return runtime.events.ResumeAfterStartupGuard(ctx, lease)
}
