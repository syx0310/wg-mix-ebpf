...
func InspectExperimentalFakeTCPObjectTestPrograms(context.Context, string) (ObjectIdentity, []string, error) {
	return ObjectIdentity{}, nil, ErrUnsupported
}

func InspectLegacy515FakeTCPObjectTestPrograms(context.Context, string) (ObjectIdentity, []string, error) {
	return ObjectIdentity{}, nil, ErrUnsupported
}

func LoadExperimentalFakeTCPObjectProgramTestIdentity(context.Context, string, string) (ObjectIdentity, error) {
	return ObjectIdentity{}, ErrUnsupported
}

func LoadLegacy515FakeTCPObjectProgramTestIdentity(context.Context, string, string) (ObjectIdentity, error) {
	return ObjectIdentity{}, ErrUnsupported
}
